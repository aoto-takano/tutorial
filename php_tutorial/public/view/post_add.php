    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <div class="btn-group">
                         <a style="color: white; font-size: 13px; margin-right: 20px;" href="http://localhost:8888/php_tutorial/post/add">タスクの追加</a>
                    </div>
        ...
        <div class="col-lg-8 col-md-10 mx-auto">
            <form method="post" action="./add">
                <div class="post">
                    ...
                    <p><input class="btn btn-primary" name="submit" type="submit" value="追加"></p>
                </div>
            </form>
        </div>
    </div>
